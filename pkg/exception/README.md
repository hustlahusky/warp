...
Tools to design friendly and translatable exceptions
...
```bash
$ composer require getwarp/exception
```
...
[link-github]: https://github.com/getwarp/exception
[link-packagist]: https://packagist.org/packages/getwarp/exception
