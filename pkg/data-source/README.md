...
```bash
$ composer require getwarp/data-source
```
...
- [`getwarp/cycle-bridge`][link-cycle-bridge]: integration with Cycle ORM
...
[link-github]: https://github.com/getwarp/data-source
[link-packagist]: https://packagist.org/packages/getwarp/data-source
...
[link-cycle-bridge]: https://github.com/getwarp/cycle-bridge
